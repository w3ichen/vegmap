...
namespace vegmap_planner
{
     ...
     * Ideally this method should clean up resources which are created for the planner.
     */
    void Vegmap::cleanup()
    {
        RCLCPP_INFO(
     ...
     */
    nav_msgs::msg::Path Vegmap::createPlan(
...
PLUGINLIB_EXPORT_CLASS(vegmap_planner::Vegmap, nav2_core::GlobalPlanner)